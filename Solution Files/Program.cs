...
namespace KIT206
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Student_Controller sController = new Student_Controller();
            sController.SelectStudent(123470);

            sController.AddStudentDetails("Mr", Campus.Hobart, "somethign@gmail.com", Category.Bachelors, "04 6934 2781");
            //new meeting controller for meetings from gorup 1
            //Meeting_Controller controller = new Meeting_Controller(1);
            //controller.ListMeetings();

            //controller.EditMeeting(1, Day.Wednesday, TimeSpan.Parse("03:30:00"), TimeSpan.Parse("8:00:00"));
            //controller.ListMeetings();
